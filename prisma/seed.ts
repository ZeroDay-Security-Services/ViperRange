...
interface SeedLab {
  slug: string;
  name: string;
  category: "WEB_APP" | "CRYPTO" | "FORENSICS" | "LINUX" | "PWN" | "REVERSING" | "OSINT" | "MISC";
  difficulty: "BEGINNER" | "INTERMEDIATE" | "ADVANCED" | "EXPERT";
  labType: "DEPLOYABLE" | "OFFLINE";
  tags: string[];
  description: string;
  points: number;
  ...
  maxDuration: number;
  flag: string;
  hints: Array<{ order: number; text: string; pointsPenalty?: number }>;
  resources: Array<{ name: string; description: string; url: string }>;
  isFeatured: boolean;
  walkthroughs: SeedWalkthrough[];
}
